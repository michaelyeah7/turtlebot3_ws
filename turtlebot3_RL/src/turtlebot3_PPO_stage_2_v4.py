...
from environment_stage_2_v4 import Env
...
A_UPDATE_STEPS = 10
C_UPDATE_STEPS = 10
S_DIM, A_DIM = 16, 1  #QinjieLin 16,1
METHOD = [
...
class PPO(object):
    ...
    def save_model(self,step):
        ...
        cpath = os_path + '/saved_model/V4/my_test_model-'+str(step)+'.ckpt'
...
for ep in range(EP_MAX):
    ...
    for t in range(EP_LEN):    # in one episode
        ...
        if(done):
            env.reset()
    ppo.save_model(ep)#qinjielin: not save model yet
