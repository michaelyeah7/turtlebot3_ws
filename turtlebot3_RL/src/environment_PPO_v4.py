...
class Env():
    def __init__(self,):
        ...
        self.scan_0 = [3.5,3.5,3.5,3.5,3.5,3.5]
        self.scan_1 = [3.5,3.5,3.5,3.5,3.5,3.5]
        self.scan_2 = [3.5,3.5,3.5,3.5,3.5,3.5]
    ...
    def getState(self, scan):
        ...
        self.scan_0 = self.scan_1.copy()
        self.scan_1 = self.scan_2.copy()
        self.scan_2 = scan_range.copy()

        return self.scan_0+self.scan_1+self.scan_2 + [heading, current_distance, obstacle_min_range, obstacle_angle], done
    ...
    def setReward(self, state, done, action):
        ...
        obs_reward = 0
        if ((obs_min_range > 0.13) and (obs_min_range < 0.35)):
            obs_reward -= (0.35 - obs_min_range) * 0.3 * self.obs_weight
