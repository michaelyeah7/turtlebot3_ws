...
world_name = rospy.get_param("BASE_WORLD","empty.world")
actor_number = rospy.get_param("ACTOR_NUMBER",1.0)
...
# startingPosition = {0:(-4.0,4.0), 1:(-4.0,1.5), 2:(3, -0.5), 3:(2.5,0.5)}
# targetPosition = {0: (-1.0,3.5), 1:(-1.0,1.5),   2:(-2.5, -0.5), 3:(-3,0.5)}
# speedOfActor = {0:1.2,1:0.9,2:1.1,3:1.2}
#for item in range(4):
#    speedOfActor[item] = 1.00
startingPosition = {0:(6.5,-1.0), 1:(-4.0,1.5), 2:(3, -0.5), 3:(2.5,0.5)}
targetPosition = {0: (9.0,-2.0), 1:(-1.0,1.5),   2:(-2.5, -0.5), 3:(-3,0.5)}
...
tree_.write(actor_pkg_path+'/worlds/FancyRoomWorld.world', pretty_print=True, xml_declaration=True, encoding="utf-8")
